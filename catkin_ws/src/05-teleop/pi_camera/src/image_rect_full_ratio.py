...
class ImgRectFullRatio(object):
    ...
    def __init__(self):
        ...
        self.ready_to_start_processing = False
    ...
    def cbCamInfo(self,caminfo_msg):
        ...
        if self.gpg is None:
            ...
            self.ready_to_start_processing = True

    def cbImg(self,msg):
        rospy.sleep(0.05)
        if self.ready_to_start_processing:
            #print "[RECT] XXXXXXXXXXXX    1     XXXXXXXXXXXX"
            if not self.active:
                print "[RECT] XXXXXXXXXXXX    NOT ACTIVE     XXXXXXXXXXXX"
                return
            if self.cam_info is None:
                print "[RECT] XXXXXXXXXXXX    cam_info None     XXXXXXXXXXXX"
                return
            if self.gpg is None:
                print "[RECT] XXXXXXXXXXXX    gpg None     XXXXXXXXXXXX"
                return
            #print "[RECT] XXXXXXXXXXXX    2     XXXXXXXXXXXX"
            ...
            rospy.logwarn("[image_rect_full_ratio] image_rect_full_ratio is not ready to start processing ")
